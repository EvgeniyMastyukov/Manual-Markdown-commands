...
![Солнце](./картинки/sun.png "Локально")
![Российский флаг](./картинки/flag.jpeg "Локально")
...
[Geek Brains](https://gb.ru/ "Школа программирования")   
...
Идентификаторы ссылок могут состоять из букв, цифр, пробелов и знаков пунктуации, однако они не чувствительны к регистру. То есть эти два варианта эквивалентны. Пример:

[id]:https://gist.github.com/Jekins/2bf2d0638163f1294637#Links "github"
